...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.hapticsTitle": "Vibration on send / stop",
    "settings.hapticsDescription": "Short vibration pulses when sending or stopping (Android).",
    ...
    "chat.offline": "Offline — messages can only be sent once the connection is back",
    "chat.steer": "Steer",
    ...
    "chat.pinnedModels": "Pinned",
    "chat.pinModel": "Pin model",
    "chat.unpinModel": "Unpin model",
    ...
    "i18n.close": "Close",
    "pwa.installHint": "Add Pi Web to your home screen for an app-like experience",
    "i18n.copy": "Copy",
    "i18n.copied": "Copied",
    "i18n.cancel": "Cancel",
    "i18n.save": "Save",
    ...
    "i18n.providerOrderMoveUp": "Move up",
    "i18n.providerOrderMoveDown": "Move down",
