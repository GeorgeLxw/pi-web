...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.hapticsTitle": "发送/停止时振动",
    "settings.hapticsDescription": "发送或停止时给出短暂振动反馈(Android)。",
    ...
    "chat.pinnedModels": "已置顶",
    "chat.pinModel": "置顶模型",
    "chat.unpinModel": "取消置顶",
    ...
    "i18n.close": "关闭",
    "pwa.installHint": "将 Pi Web 添加到主屏幕,获得接近原生 App 的体验",
    "i18n.copy": "复制",
    "i18n.copied": "已复制",
    "i18n.cancel": "取消",
    "i18n.save": "保存",
    ...
    "i18n.providerGroupOrder": "聊天分组顺序",
    "i18n.providerGroupOrderDescription": "默认按 Provider 名称字母序排列;拖拽即可自定义顺序,保存后聊天模型下拉会按同样顺序显示。",
    "i18n.providerGroupOrderReset": "恢复默认顺序",
    "i18n.providerOrderMoveUp": "上移",
    "i18n.providerOrderMoveDown": "下移",
    "i18n.dragToReorder": "拖拽排序",
