...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "settings.hapticsTitle": "傳送/停止時震動",
    "settings.hapticsDescription": "傳送或停止時提供短暫震動回饋(Android)。",
    ...
    "sidebar.searchSessions": "搜尋會話…",
    "sidebar.noMatchingSessions": "沒有相符的會話",
    ...
    "chat.pinnedModels": "已置頂",
    "chat.pinModel": "置頂模型",
    "chat.unpinModel": "取消置頂",
    ...
    "i18n.close": "關閉",
    "pwa.installHint": "將 Pi Web 加入主畫面,獲得接近原生 App 的體驗",
    "i18n.copy": "複製",
    "i18n.copied": "已複製",
    "i18n.cancel": "取消",
    "i18n.save": "儲存",
